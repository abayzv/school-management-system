...
class CollectFee extends React.Component {
    ...
    collect = (datas) => {
        axios({
            ...
            this.props.history.push(`/collectfee/${datas}`)
        }).catch(error => {
            swalWithBootstrapButtons.fire({
                title: 'Fee Doesnt Exist',
                text: "Please assign Fee before collect!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Assign Fee Now!',
                cancelButtonText: 'Cancel',
                reverseButtons: true
            }).then((result) => {
                if (result.isConfirmed) {
                    this.props.history.push(`/feemaster`)
                } else if (
